...
<nav class="nav">
  <div class="nav__inner">
    <a href="index.php" class="nav__logo">Sint<em>a</em></a>
    <div class="nav__links">
      <a href="index.php">Home</a><a href="occasions.php">Occasions</a>
      <a href="bundles.php">Bundles</a><a href="gallery.php">Gallery</a>
      <a href="about.php" class="active">About</a><a href="contact.php">Contact</a>
    </div>
    <div class="nav__actions">
      <a href="signin.php" class="btn btn--ghost btn--sm">Sign In</a>
      <a href="signup.php" class="btn btn--dark btn--sm">Get Started</a>
    </div>
  </div>
</nav>
