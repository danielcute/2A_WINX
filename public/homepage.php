<?php session_start(); $page = 'homepage'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <main class="home-main">
    ...
    <section class="home-hero animate-fade-up">
      <div class="home-hero__content">
        ...
        <h1 class="home-hero__title">Good morning, <em>Maria!</em></h1>
        <p class="home-hero__sub">What kind of celebration are we planning today?</p>
        <div class="home-hero__actions">
          <a href="occasions.php" class="btn btn--primary btn--lg"><i class="fas fa-sparkles"></i> Start Planning</a>
          <a href="packages.php" class="btn btn--outline btn--lg"><i class="fas fa-box"></i> Browse Packages</a>
        </div>
      </div>
    ...
    <section class="home-section">
      <div class="home-section__head">
        ...
        <a href="occasions.php" class="btn btn--ghost btn--sm">View All <i class="fas fa-arrow-right"></i></a>
      </div>
      <div class="occasions-grid stagger">
        <a href="packages.php?occasion=wedding" class="occasion-card">
        ...
        <a href="packages.php?occasion=birthday" class="occasion-card">
        ...
        <a href="packages.php?occasion=debut" class="occasion-card">
        ...
        <a href="packages.php?occasion=corporate" class="occasion-card">
        ...
        <a href="packages.php?occasion=anniversary" class="occasion-card">
        ...
        <a href="packages.php?occasion=other" class="occasion-card occasion-card--more">
          <div class="occasion-card__content">
    ...
    <section class="home-section">
      <div class="home-section__head">
        ...
        <a href="plans.php" class="btn btn--ghost btn--sm">View All <i class="fas fa-arrow-right"></i></a>
      </div>
    ...
    <section class="home-section">
      ...
      <div class="testimonials-grid stagger">
        <div class="testimonial-card">
          <img src="assets/img/wedding2.jpg" alt="Wedding">
        ...
        <div class="testimonial-card">
          <img src="assets/img/corporate2.jpg" alt="Corporate">
          <div class="testimonial-card__overlay">
            <div class="testimonial-card__stars">★★★★★</div>
        ...
        <div class="testimonial-card">
          <img src="assets/img/birthday2.jpg" alt="Birthday">
          <div class="testimonial-card__overlay">
            <div class="testimonial-card__stars">★★★★★</div>
        ...
        <div class="testimonial-card">
          <img src="assets/img/anniversary2.jpg" alt="Anniversary">
          <div class="testimonial-card__overlay">
            <div class="testimonial-card__stars">★★★★★</div>
