...
<div class="app-shell">
  <main class="plans-main">
    ...
    <div class="plans-header animate-fade-up">
      ...
      <a href="occasions.php" class="btn btn--primary"><i class="fas fa-plus"></i> New Event</a>
    </div>
    ...
    <div class="plans-grid stagger" id="plansGrid">
      <?php
      $events = [
        ['id'=>1,'name'=>'Santos Wedding', 'type'=>'Wedding', 'date'=>'Aug 12, 2025','location'=>'Bacolod City','status'=>'confirmed','price'=>'₱220,000','img'=>'assets/img/wedding2.jpg'],
        ['id'=>2,'name'=>"Mom's 70th Birthday",'type'=>'Birthday', 'date'=>'Oct 3, 2025', 'location'=>'Iloilo City', 'status'=>'planning', 'price'=>'₱85,000', 'img'=>'assets/img/birthday2.jpg'],
        ['id'=>3,'name'=>'Ayala Gala Night', 'type'=>'Corporate','date'=>'Nov 28, 2025','location'=>'Bacolod City','status'=>'pending',  'price'=>'₱200,000','img'=>'assets/img/ayala.jpg'],
        ['id'=>4,'name'=>'Reyes Wedding', 'type'=>'Wedding', 'date'=>'Mar 15, 2025','location'=>'Manila', 'status'=>'completed','price'=>'₱180,000','img'=>'assets/img/wedding3.jpg'],
        ['id'=>5,'name'=>"Lani's Debut", 'type'=>'Debut', 'date'=>'Jan 20, 2025','location'=>'Bacolod City','status'=>'completed','price'=>'₱95,000', 'img'=>'assets/img/debut.jpg'],
        ['id'=>6,'name'=>'TechCorp Summit', 'type'=>'Corporate','date'=>'Feb 8, 2025', 'location'=>'Cebu City', 'status'=>'completed','price'=>'₱250,000','img'=>'assets/img/corporate2.jpg'],
      ];
      ...
      foreach($events as $e): ?>
      <a href="event-detail.php?id=<?= $e['id'] ?>" class="plan-card" data-status="<?= $e['status'] ?>">
