<?php session_start(); $page = 'occasions'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="app-shell">
  <main class="occ-main">
    ...
    <div class="occ-grid stagger">
      <a href="packages.php?occasion=wedding" class="occ-card">
        <div class="occ-card__img" style="background-image:url('assets/img/wedding.jpg')"></div>
      ...
      <a href="packages.php?occasion=debut" class="occ-card">
        <div class="occ-card__img" style="background-image:url('assets/img/debut.jpg')"></div>
        <div class="occ-card__body">
      ...
      <a href="packages.php?occasion=birthday" class="occ-card">
        <div class="occ-card__img" style="background-image:url('assets/img/birthday.jpg')"></div>
        <div class="occ-card__body">
      ...
      <a href="packages.php?occasion=corporate" class="occ-card">
        <div class="occ-card__img" style="background-image:url('assets/img/corporate.jpg')"></div>
        <div class="occ-card__body">
      ...
      <a href="packages.php?occasion=anniversary" class="occ-card">
        <div class="occ-card__img" style="background-image:url('assets/img/anniversary.jpg')"></div>
        <div class="occ-card__body">
      ...
      <a href="packages.php?occasion=other" class="occ-card">
