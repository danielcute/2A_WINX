    ...
    <div class="occasions-container">
        ...
        <?php if (!empty($categoryCounts)): ?>
            <div class="category-summary">
                ...
                <p class="category-summary-note">
                    These categories are available for the Customize page and can be managed in
                    <a href="<?= BASE_URL ?>/index.php?route=admin-customize">Customize management</a>.
                </p>
            </div>
        <?php endif; ?>
                    ...
                    <div class="occasion-card">
                        ...
                        <div style="padding: 1.5rem 1.5rem 0 1.5rem;">
                            ...
                            <div class="occasion-actions" style="margin-top: 1rem; padding-bottom: 1.5rem;">
                                <button class="btn btn--primary btn--sm btn-animation" onclick="editOccasion(<?= (int)$occasion['occasion_id'] ?>)">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                                <button class="btn btn--ghost btn--sm btn-animation btn-delete-custom" onclick="deleteOccasion(<?= (int)$occasion['occasion_id'] ?>)">
...
function editOccasion(id) {
    ...
    fetch(baseUrl + '/api-occasion.php?id=' + id, {
        ...
        .then(data => {
            if (!data.success) {
                alert(data.message || 'Failed to load occasion');
                return;
            }
...
function deleteOccasion(id) {
    ...
    .then(response => {
        if (response.status === 401) {
            ...
            window.location.href = '<?= BASE_URL ?>/index.php?route=signin';
            return null;
        }
    ...
    .catch(error => {
        ...
        alert('Error deleting occasion: ' + (error?.message || error));
    });
}
...
function clearImagePreview() {
    const imgInput = document.getElementById('occasionImage');
