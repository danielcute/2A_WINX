                ...
                <div class="testimonial-card" id="testimonial-<?= $t['review_id'] ?>">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        <?php if ($t['status'] !== 'approved'): ?>
                            <button class="btn btn--primary btn-sm" onclick="updateStatus(<?= $t['review_id'] ?>, 'approved')">Approve</button>
                        <?php endif; ?>
                        <button class="btn btn--ghost btn-sm" onclick="deleteTestimonial(<?= $t['review_id'] ?>)">Delete</button>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
