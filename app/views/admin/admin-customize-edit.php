...
<body>
    ...
    <div class="form-container">
        <h1>✏️ Edit Customization Option</h1>
        <div class="option-id">Option ID: #<?php echo $option['option_id']; ?></div>

        <form method="POST" action="<?php echo BASE_URL; ?>/index.php?route=admin-customize-update">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit">✓ Update Customization</button>
